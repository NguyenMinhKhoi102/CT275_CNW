...
<body class="container-fluid">
    ...
    <div class="row">
        ...
        <main class="col-10 mb-5">
            ...
            <a href="./xulysanpham.php" class="btn btn-primary" style="margin-block: 30px;">
                ...
                <tbody>
                    ...
                    foreach ($ds as $sanpham) : ?>
                        <tr>
                            ...
                            <td><?= $sanpham->getLoai_Id() ?></td>
                            <td><?= $sanpham->giamgia ?></td>
                            <td>
                                <a href="<?= "./xulysanpham.php?id=" . $sanpham->getId() ?>" class="btn btn-warning">Edit</a>
                                <form class="delete" action="<?= './xulysanpham.php' ?>" method="POST" onsubmit="return allow()" style="display: inline;">
